...
Enable the openclaw-mesh plugin to trigger autonomous agent turns from its webhook handler. When a Hermes agent sends an mesh message via the inbound webhook, EMTS should wake up and process it without Emil triggering a turn.
