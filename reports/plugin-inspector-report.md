...
| ------------- | -------- | ------------ | --------- | ------------------------------- | ------------------ |
| openclaw-mesh | high     | dynamic-tool | agent_end | definePluginEntry, registerTool | httpRoutes, tools  |
...
| ------------- | --------------------------- | ----- | ------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------ | ------------- |
| openclaw-mesh | seam-inventory              | log   | observed 1 hooks, 2 registrations, and 2 manifest contracts                           | hook:agent_end, registration:definePluginEntry, registration:registerTool, manifestContract:httpRoutes, manifestContract:tools | -             |
| openclaw-mesh | package-metadata            | log   | selected package metadata for plugin contract checks                                  | package.json, @emiltsoi/openclaw-mesh, version:0.1.4                                                                           | -             |
| openclaw-mesh | declarative-contracts       | log   | fixture declares manifest contracts that can be checked without executing plugin code | httpRoutes, tools                                                                                                              | -             |
